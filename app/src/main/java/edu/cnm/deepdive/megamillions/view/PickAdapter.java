...
public class PickAdapter extends RecyclerView.Adapter<PickAdapter.Holder> {
  ...
  public PickAdapter(Context context, List<int[]> picks) {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
     holder.bind(); //TODO Pass current PickWithNubers instance.
     if (position % 2 == 1) {
       holder.itemView.setBackgroundColor(Color.argb(32, 0, 0, 0));
     }
    //TODO see if there is a different way to alternate color.
    }
    ...
    public class Holder extends RecyclerView.ViewHolder
      ...
      public Holder(@NonNull View view) {
       ...
       for (int i = 0; i < PICK_LENGTH; i++) {
         int id = context.getResources().getIdentifier("num_" + i,"id",
      ...
      private void bind() {
        ...
        for (int i = 0; i < numbers.length; i++) {
          ...
          //zerp pad to make 2 digit number for 9 <.
        }
